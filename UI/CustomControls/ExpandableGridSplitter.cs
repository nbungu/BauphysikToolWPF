        ...
        private void ExpanderButton_Click(object sender, RoutedEventArgs e)
        {
            if (this.Parent is Grid grid)
            {
                if (this.HorizontalAlignment == HorizontalAlignment.Stretch)
                {
                    ...
                    rowDefinition.Height = rowDefinition.Height.Value > 0 ? new GridLength(0) : new GridLength(1, GridUnitType.Star);
                }
                else
                {
                    ...
                    columnDefinition.Width = columnDefinition.Width.Value > 0 ? new GridLength(0) : new GridLength(1, GridUnitType.Star);
                }
            }
        }
    }
