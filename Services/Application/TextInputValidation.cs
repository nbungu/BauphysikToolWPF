...
namespace BauphysikToolWPF.Services.Application
{
    public static class TextInputValidation
    {
        ...
        public static Regex NumericCurrentCulturePositive = new Regex(@"[^0-9,.]+"); //regex that matches disallowed text

        public static Regex IntegerCurrentCulture = new Regex(@"(?!^-)[^-0-9]+"); //regex that matches disallowed text

        public static Regex IntegerCurrentCulturePositive = new Regex(@"[^0-9]+"); //regex that matches disallowed text
