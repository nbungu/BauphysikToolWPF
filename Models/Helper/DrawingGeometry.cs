...
namespace BauphysikToolWPF.Models.Helper
{
    ...
    public class DrawingGeometry // RF to DrawingGeometry
    {
        ...
        public Brush RectangleStrokeColor { get; set; } = Brushes.Black;
        public double RectangleStrokeThickness { get; set; } = 1.0;
        ...
        public void UpdateGeometry(Layer layer)
        {
            ...
            RectangleStrokeColor = layer.IsSelected ? new SolidColorBrush((Color)ColorConverter.ConvertFromString("#1473e6")) : Brushes.Black;
            RectangleStrokeThickness = layer.IsSelected ? 1 : 0.2;
