...
namespace BauphysikToolWPF.Models.Domain.Helper
{
    public static class ProjectExtensions
    {
        ...
        {
            if (project is null || newElement is null) return;
        ...
        {
            if (project is null || project.Elements.Count == 0) return;
        ...
        {
            if (project is null || project.EnvelopeItems.Count == 0) return;
        ...
        {
            if (project is null || newItem == null) return;
        ...
        {
            if (project is null || project.Elements.Count == 0 || material is null) return false;
